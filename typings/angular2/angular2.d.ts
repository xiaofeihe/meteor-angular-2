...
declare module ng {  
  ...
  class DirectiveMetadata extends InjectableMetadata {
     ...
     * on the DOM element that has ng-collections directive on it.
     * 
     * ```typescript
     * @Directive({
     *   selector: '[ng-collections]',
     *   host: {
     *     '[class.valid]': 'valid',
     ...
     * @Component({
     *   selector: 'app',
     *   template: `<input [(ng-collections)]="prop">`,
   ...
   * 
   * ```typescript
   * @Directive({selector: '[ng-collections]'})
   * class NgModelStatus {
   *   constructor(public control:NgModel) {}
  ...
  class NgZone {
     ...
     * sync the UI with any collections changes that occur within this callback.
     * 
     ...
     * 
     * Use {@link #run} to reenter the Angular zone and do work that updates the application collections.
     */
   ...
   *  ```
   * 
   * We can also use ng-collections to bind a domain collections to the form.
   * 
   *  ```
   * @Component({
   *      selector: "login-comp",
   ...
   *      template: `
   *        <form (submit)='onLogIn()'>
   *          Login <input type='text' ng-control='login' [(ng-collections)]="credentials.login">
   *          Password <input type='password' ng-control='password'
   *                          [(ng-collections)]="credentials.password">
   *          <button type='submit'>Log in!</button>
   *        </form>
   *      `})
   * class LoginComp {
   ...
   *      selector: "login-comp",
   *      directives: [FORM_DIRECTIVES],
   *      template: "<input type='text' [ng-form-control]='loginControl' [(ng-collections)]='login'>"
   *      })
   * class LoginComp {
   *  loginControl: Control = new Control('');
   *  login:string;
  ...
  /**
   * Binds a domain collections to a form control.
   * 
   * ##Usage
   * 
   * `ng-collections` binds an existing domain collections to a form control. For a
   * two-way binding, use `[(ng-collections)]` to ensure the collections updates in
   * both directions.
   * 
   ...
   *      directives: [FORM_DIRECTIVES],
   *      template: `<input type='text' [(ng-collections)]="searchQuery">`
   *      })
   * class SearchComp {
   *  searchQuery: string;
   * }
   ...
   *       <form [ng-form-collections]="loginForm">
   ...
   *  ### Example
   *  ```
   *  <input type="text" [(ng-collections)]="searchQuery">
   *  ```
   */
  ...
  /**
   * An error thrown if application changes collections breaking the top-down data flow.
   * 
  ...
  abstract class ChangeDetectorRef {
     ...
     *   providers: [DataProvider],
     *   template: `
     *     Live Update: <input type="checkbox" [(ng-collections)]="live">
